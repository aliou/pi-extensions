...
| `chrome/` | Header, footer, terminal title, notifications, auto-naming; footer shows cost, context, cache hit rate, and resume cache freshness | `hooks/`, `components/`, `lib/`, `native/` |
