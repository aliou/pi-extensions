...
export function renderOracleHeader(
  args: OracleParamsType & { sessionId?: string },
  theme: Theme,
...
export function renderOracleDetails(
  args: OracleParamsType,
  _theme: Theme,
  cwd: string,
) {
...
export const oracleToolRenderers: Record<string, SubagentToolRenderer> = {
