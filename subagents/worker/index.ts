...
import { pluralize } from "@subagents/lib/ui/stats";
import { WORKER_SYSTEM_PROMPT } from "@subagents/worker/system-prompt";
import { createWorkerToolFormatter } from "@subagents/worker/tool-formatter";
import { createWorkerTools } from "@subagents/worker/tools";
import type { WorkerDetails, WorkerInput } from "@subagents/worker/types";
